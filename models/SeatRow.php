...
function getSeatRowsBySession($conn, $sessionId) {
...
function seatRowExists($conn, $sessionId, $rowLabel, $side) {
...
function createSeatRowWithSeats($conn, $sessionId, $rowLabel, $side, $capacity) {
...
function deleteSeatRow($conn, $id) {

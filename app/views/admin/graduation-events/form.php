<h1 class="text-2xl font-bold text-slate-800 tracking-tight mb-6"><?= !empty($event['id']) ? 'Edit Periode Wisuda' : 'Tambah Periode Wisuda' ?></h1>
...
<div class="p-6 rounded-2xl shadow-2xs border border-slate-200/80 bg-white">
    <form method="POST" class="flex flex-col gap-4">
        ...
        <div>
            <label for="name" class="block text-sm font-medium text-slate-700 mb-1">Nama Periode Wisuda</label>

<h1 class="text-xl font-bold text-gray-800 mb-6"><?= !empty($session['id']) ? 'Edit Sesi Wisuda' : 'Tambah Sesi Wisuda' ?></h1>
...
<div class="p-6 rounded-xl shadow-sm border border-gray-200 bg-white">
    <form method="POST" class="flex flex-col gap-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
                <label for="date" class="block text-sm font-medium text-gray-700 mb-1">Tanggal Sesi</label>
            ...
            <div>
                <label for="session" class="block text-sm font-medium text-gray-700 mb-1">Sesi Ke-</label>
